	...
	theme: {
		extend: {
			...
			fontFamily: {
				...
				sans: ['Inter', 'Poppins', 'sans-serif'], // Esto se puede cambiar según tu preferencia
				header: ['Poppins', 'sans-serif'], // Usado para títulos
				body: ['Roboto', 'sans-serif'], // Usado para texto normal
			},
			borderRadius: {
				lg: 'var(--radius)',
